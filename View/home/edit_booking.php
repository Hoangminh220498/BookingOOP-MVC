            ...
            <div class="row">
                <div class="booking-form">
                    <div class="form-header">
                        <h1>Edit Make your reservation</h1>
                    </div>
                    <form action="?controller=user&action=&id=<?= $dataBooking['id']; ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" type="" placeholder="Enter Room Number" name="room_number" readonly value="<?= $dataBooking['room_number']; ?>">
                                    <span class="form-label">Room Number</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" type="" placeholder="" readonly name="price" value="<?= $dataBooking['price']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" type="date" required name="check_in" value="<?= $dataBooking['check_in']; ?>">
